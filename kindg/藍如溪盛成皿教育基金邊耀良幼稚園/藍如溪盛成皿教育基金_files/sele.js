...
function btn(id) {
	...
	switch(id)
	{
		...
		case 2:{
			selectPage('php/webinfo/show2.php?id=2')
			break;
		}
		case 3:{
			//selectPage('php/lesson/picture.php')
			
				selectPage('php/fac/picture.php')
			break;
		}
		
		case 4:{
			selectPage('php/act1/picture.php')
			break;
		}
		case 5:{
				selectPage('php/zuop/picture.php')
			break;
		}
		case 6:{
				selectPage('php/meefen/picture.php')
			break;
		}
		case 7:{
		...
		case 8:{
				selectPage('php/tongao2/file.php')
			break;
		}
		case 9:{
...
function   autoResize()   
  ...
  try   
  {   
    document.all["context"].style.height=context.document.body.scrollHeight;   
  }   
  catch(e){}   
  }   
